...
public class Meal extends AbstractBaseEntity {
    ...
    @NotNull(groups = {ValidationJdbc.class, Default.class})
    private LocalDateTime dateTime;

    @Column(name = "description", nullable = false)
    @NotBlank(groups = {ValidationJdbc.class, Default.class})
    @Size(min = 2, max = 120, groups = {ValidationJdbc.class, Default.class})
    private String description;

    @Column(name = "calories", nullable = false)
    @Range(min = 10, max = 5000, groups = {ValidationJdbc.class, Default.class})
